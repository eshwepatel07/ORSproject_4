...
<%@page import="in.co.rays.ORSProj4.controller.TimeTableCtl"%>
...
<body>
<jsp:useBean id="bean" class="in.co.rays.ORSProj4.bean.TimeTableBean" scope="request"></jsp:useBean>
...
<table>
 ...
 <tr><th style="padding: 3px"></th></tr>  
	...
	<td> <input type="text" readonly="readonly" id="udate5" size="21" placeholder="Select Date" name="ExDate" value="<%=DataUtility.getDateString(bean.getExamDate()) %>">
