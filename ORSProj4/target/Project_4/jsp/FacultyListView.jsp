...
<%@page import="in.co.rays.ORSProj4.controller.FacultyListCtl"%>
...
<jsp:useBean id="colbean" class="in.co.rays.ORSProj4.bean.CollegeBean" scope="request"></jsp:useBean>
<jsp:useBean id="corbean" class="in.co.rays.ORSProj4.bean.CourseBean" scope="request"></jsp:useBean>
