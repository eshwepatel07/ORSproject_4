...
<%@page import="in.co.rays.ORSProj4.model.StudentModel"%>
<%@page import="in.co.rays.ORSProj4.controller.StudentListCtl"%>
...
<body>
<jsp:useBean id="cbean" class="in.co.rays.ORSProj4.bean.CollegeBean" scope="request" ></jsp:useBean>
<jsp:useBean id="bean" class="in.co.rays.ORSProj4.bean.StudentBean" scope="request" ></jsp:useBean>
