<%@page import="in.co.rays.ORSProj4.controller.MarksheetCtl"%>
...
<center>
            ...
            <table align="center">
                <tr>
                    ...
                    <td><input type="text" name="rollNo" placeholder="Enter RollNo" size="21"
                ...
                <tr><th style="padding: 3px"></th></tr>
                  ...
                  <tr>
                    ...
                    <td>
                    <%=HTMLUtility.getList("studentId",DataUtility.getStringData(bean.getStudentId()), l)%>
                    </td>
                  ...
                  <td><input type="number" name="physics" maxlength="3" placeholder="Enter Physics Marks" 
                ...
                <tr>
                    <th align="left">Chemistry<span style="color: red">*</span> :</th>
                     <td><input type="number" name="chemistry" maxlength="3" placeholder="Enter Chemistry Marks" size="21"
                ...
                <tr >
                  ...
                  <td><input type="number" name="maths" maxlength="3" placeholder="Enter Maths Marks"  size="23" 
