...
public class UserListCtl extends BaseCtl{
    ...
    protected void preload(HttpServletRequest request){
    	 System.out.println(">>>>>>>>>in preload user list ctl");
    ...
    protected BaseBean populateBean(HttpServletRequest request) {
    	 System.out.println(">>>>>>>>>in populatebean user list ctl");
...
//            bean.setId(DataUtility.getLong(request.getParameter("ulist")));
          //  bean.setFirstName(DataUtility.getString(request.getParameter("ulist")));
        //    System.out.println("fname>>>>"+request.getParameter("ulist"));
    ...
    protected void doGet(HttpServletRequest request,
        ...
        System.out.println(">>>>>>>>>in doGet user list ctl");
        List list = null;
        List nextList=null;
...
//        String[] ids = request.getParameterValues("ids");
    ...
    protected void doPost(HttpServletRequest request,
        ...
        System.out.println(">>>>>>>>>in dopost user list ctl");
        List list;
        List nextList=null;
        ...
        String op = DataUtility.getString(request.getParameter("operation"));
        System.out.println("op in dopost >>>>>>>>"+ op);
        UserBean bean = (UserBean) populateBean(request);
        // get the selected checkbox ids array for delete list
        String[] ids = request.getParameterValues("ids");
       // System.out.println("selected ids via check box>>>>>>"+ids[1]);
        UserModel model = new UserModel();
                ...
                return;
                    ...
                    for (String id : ids) {
                        ...
                        System.out.println("delete ids in dopost userlistctl"+deletebean.getId());
                        try {
