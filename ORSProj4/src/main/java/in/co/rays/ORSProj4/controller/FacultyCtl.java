...
public class FacultyCtl extends BaseCtl{
	...
	protected BaseBean populateBean(HttpServletRequest request) {
        ...
        //System.out.println("my dob>>>>>>>>>>>"+request.getParameter("dob"));
		bean.setCollegeId(DataUtility.getLong(request.getParameter("collegeid")));
		System.out.println("my colg id>>>>>>>>>>>"+request.getParameter("collegeid"));
		bean.setCourseId(DataUtility.getLong(request.getParameter("courseid")));
		System.out.println("my course id>>>>>>>>>>>"+request.getParameter("courseid"));
		bean.setSubjectId(DataUtility.getLong(request.getParameter("subjectid")));
		System.out.println("my s id>>>>>>>>>>>"+request.getParameter("subjectid"));
...
//					System.out.println("in do post>>>>>>>>>>"+bean.getDob());
//					System.out.println("in do post name>>>>>>>>>>"+bean.getFirstName());
//					System.out.println("in do post email>>>>>>>>>>"+bean.getEmailId());
