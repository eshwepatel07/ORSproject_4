...
public class CollegeCtl extends BaseCtl{
    ...
    protected BaseBean populateBean(HttpServletRequest request) {
        ...
        System.out.println("college name>>>>>>>>>>"+request.getParameter("name"));
        ...
        System.out.println("phone no>>>>>>>>>>"+request.getParameter("phoneNo"));
    ...
    protected void doGet(HttpServletRequest request,
        ...
        if (id > 0) {
            ...
            try {
            	...
            	System.out.println("catch from get method");
                e.printStackTrace();
            	//log.error(e);
	...
	{
		log.debug("college method do post start");
		
		//String op=DataUtility
		String op = DataUtility.getString(request.getParameter("operation"));
		long id = DataUtility.getLong(request.getParameter("id"));
