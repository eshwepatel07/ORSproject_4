...
public class UserCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		bean.setMobileNo(DataUtility.getString(request.getParameter("mno")));
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("op inside doget of userctl>>>>>>>>"+request.getParameter("operation"));
	// get model
		UserModel model = new UserModel();
		long id = DataUtility.getLong(request.getParameter("id"));
		System.out.println("id after edit inside doget>>>>>"+request.getParameter("id"));
		if (id > 0 || op != null) {
