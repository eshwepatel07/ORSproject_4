...
public class SubjectModel {
 ...
 public long add(SubjectBean bean) throws ApplicationException,
        ...
        bean.setCourseName(CourseBean.getName());
        		System.out.println("subject in model>>>>>>>>>>>>>"+bean.getSubjectName());
	...
	public void delete(SubjectBean bean) throws ApplicationException {
		...
		SubjectBean be= findByPk(bean.getId());
		if(be==null)
		{
 ...
 log.debug("Model update End");
	...
	public List search(SubjectBean bean, int pageNo, int pageSize) throws ApplicationException {
		...
		//System.out.println("sub id1>>>>>>>"+bean.getId());
		...
		try {
			...
			//System.out.println("sub id>>>>>>>"+bean.getId());
//			if(bean.getId()==0)
//			{
...
//			}
	...
	public List list(int pageNo, int pageSize) throws ApplicationException {
		...
		/*
		 * if (pageSize>0) { pageNo = (pageNo-1)*pageSize; sql.append(" limit "+ pageNo+
		 * " , " + pageSize); }
		 */
