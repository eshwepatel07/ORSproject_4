...
//        CollegeBean beanExist = findByPK(bean.getId());
...
//        }
        ...
        try {
            ...
            conn.setAutoCommit(false); // Begin transaction
            PreparedStatement pstmt = conn
                    .prepareStatement("UPDATE ST_COLLEGE SET NAME=?, ADDRESS=?, STATE=?, CITY=?, PHONE_NO=?, MODIFIED_BY=?, MODIFIED_DATETIME=? WHERE ID=?");
