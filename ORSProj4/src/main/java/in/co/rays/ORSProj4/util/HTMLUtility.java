...
import in.co.rays.ORSProj4.bean.DropdownListBean;
...
public class HTMLUtility {
	...
	public static String getList(String name, String selectedVal, HashMap<String, String> map) {
		...
		StringBuffer sb = new StringBuffer("<select style='width:183px; height:23px; class='form-control' name='" + name + "'>");
		...
		if(select)
		{
			sb.append("<option style=' height:30px;' selected value=''>------------------Select------------------</option>");
		}
		for (String key : keys) {
			val = map.get(key);
	 ...
	 * = ServletUtility.getErrorMessage(request); if (!DataValidator.isNull(msg)) {
	 * msg = "<p class='st-error-header'>" + msg + "</p>"; } return msg; }
	 */
	/**
	 ...
	 * msg = ServletUtility.getSuccessMessage(request); if
	 * (!DataValidator.isNull(msg)) { msg = "<p class='st-success-header'>" + msg +
	 * "</p>"; } return msg; }
	 */
	/**
