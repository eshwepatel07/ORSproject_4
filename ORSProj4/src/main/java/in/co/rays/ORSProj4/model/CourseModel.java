...
public class CourseModel {
	...
	public long add(CourseBean bean) throws ApplicationException, DuplicateRecordException {
		...
		//System.out.println("dup:=" + duplicateCourseName.getName());
...
//			throw new ApplicationException("Exception in Course Add method");
	...
	public void delete(CourseBean bean) throws ApplicationException, RecordNotFoundException {
	...
	public void update(CourseBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement(
					"UPDATE ST_COURSE SET NAME=?,DURATION=?,DESCRIPTION=?,MODIFIED_BY=?,MODIFIED_DATETIME=? WHERE ID=?");
