...
public class ChangePasswordCtl extends BaseCtl{
	...
	protected boolean validate(HttpServletRequest request) {
		...
		System.out.println("inside cp ctl validate");
		boolean pass = true;
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		System.out.println("inside cp ctl populate");
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("inside cp ctl doGet");
		HttpSession session = request.getSession(true);
		UserBean UserBean = (UserBean) session.getAttribute("user");
//		String login= (String) session.getAttribute("user");
		System.out.println("login>>>>>>>>>>>"+UserBean.getLogin());
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("inside cp ctl doPost");
		HttpSession session = request.getSession(true);
...
//			String login= (String) session.getAttribute("user");
		...
		{
			try {
				boolean flag = model.changePassword(UserBean.getLogin(), bean.getPassword(), newPassword);
				if (flag == true) {
			...
			System.out.println(" op get in doPost of cp >>>>>>>>>>>> channge my profile");
